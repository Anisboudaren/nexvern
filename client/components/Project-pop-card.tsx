              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-6 space-y-6 border-r">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 rounded-lg bg-muted/30">
                      ...
                      <p className="font-semibold">{formatDate(project.datePosted)}</p>
                    </div>
                    <div className="text-center p-4 rounded-lg bg-muted/30">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-muted">
                        ...
                        <Badge style={{ backgroundColor: project.stageColor, color: "white" }}>{project.stage}</Badge>
                      </div>
                      <div className="flex justify-between py-2 border-b border-muted">
                ...
                <div className="p-6 space-y-6">
                  ...
                  {project.roles.length > 0 && (
                    <div className="space-y-4">
                      <h4 className="text-lg font-semibold">Open Positions ({project.roles.length})</h4>
                      <div className="space-y-4">
                        {project.roles.map((role, index) => (
                          ...
                          >
                            <div className="space-y-3">
                              <div>
                                <h5 className="text-lg font-semibold text-foreground">{role.title}</h5>
                                {role.description && (
